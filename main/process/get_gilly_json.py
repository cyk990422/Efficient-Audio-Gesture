...
class PCG():
    ...
    def export(self, poses, trans, face=None, wrist='hand', protocol='gilly', frame_id=None):
        ...
        if wrist == 'hand':
            ...
            quat[0][0],quat[0][1],quat[0][2],quat[0][3]=quat[0][0],quat[0][1],quat[0][2]+0.115,quat[0][3]

            quat[15][0],quat[15][1],quat[15][2],quat[15][3]=quat[15][0],quat[15][1]-0.115,quat[15][2],quat[15][3]
            quat[7][0],quat[7][1],quat[7][2],quat[7][3]=1.,0.,0.,0.
            quat[8][0],quat[8][1],quat[8][2],quat[8][3]=1.,0.,0.,0.

            quat[29][0],quat[29][1],quat[29][2],quat[29][3]=quat[29][0],quat[29][1],quat[29][2],quat[29][3]
            quat[26][0],quat[26][1],quat[26][2],quat[26][3]=quat[26][0],quat[26][1],quat[26][2],quat[26][3]
            quat[32][0],quat[32][1],quat[32][2],quat[32][3]=quat[32][0],quat[32][1],quat[32][2],quat[32][3]

            quat[45][0],quat[45][1],quat[45][2],quat[45][3]=quat[45][0],quat[45][1],quat[45][2],quat[45][3]
            quat[42][0],quat[42][1],quat[42][2],quat[42][3]=quat[42][0],quat[42][1],quat[42][2],quat[42][3]
            quat[48][0],quat[48][1],quat[48][2],quat[48][3]=quat[48][0],quat[48][1],quat[48][2],quat[48][3]

            quat[30][0],quat[30][1],quat[30][2],quat[30][3]=quat[30][0],quat[30][1],quat[30][2],quat[30][3]
            quat[31][0],quat[31][1],quat[31][2],quat[31][3]=quat[31][0],quat[31][1],quat[31][2],quat[31][3]

            quat[47][0],quat[47][1],quat[47][2],quat[47][3]=quat[47][0],quat[47][1],quat[47][2],quat[47][3]
            #quat[46][0],quat[46][1],quat[46][2],quat[46][3]=quat[46][0],quat[46][1]+0.3,quat[46][2],quat[46][3]+0.3
            quat[46][0],quat[46][1],quat[46][2],quat[46][3]=quat[46][0],quat[46][1],quat[46][2],quat[46][3]
...
# def main():
#     face_count = 0
#     left_data = ready_mano_arguments('./MANO_LEFT.pkl')
#     left_hands_mean = left_data['hands_mean']
#     left_hands_mean = left_hands_mean.copy()

#     right_data = ready_mano_arguments('./MANO_RIGHT.pkl')
...
#     # GT
#     data = np.load('./beat_zyx_quat.npy')
#     all_trans = np.load('./beat_zyx_transl.npy')
#     print(data.shape)
...
#         tmp_trans[0],tmp_trans[1],tmp_trans[2] = tmp_trans[0],-tmp_trans[2],-tmp_trans[1]
#         new_trans =  -tmp_trans[2]*0.0, -tmp_trans[1]*0.0, tmp_trans[0]
...
#     pcg.export_json("./gtnew.json")

import os
def toue():
    face_count = 0
    left_data = ready_mano_arguments('../../process/MANO_LEFT.pkl')
    left_hands_mean = left_data['hands_mean']
    left_hands_mean = left_hands_mean.copy()

    right_data = ready_mano_arguments('../../process/MANO_RIGHT.pkl')
    right_hands_mean = right_data['hands_mean']
    right_hands_mean = right_hands_mean.copy()
